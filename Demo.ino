...
void loop() {
  ...
  //Filled Triangle    print on display                // Like above, but the triangle is filled
  for (int i=0;i<8;i++)
  {
  matrix.fillScreen(0);      
 ...
 String my_string = "Void Loop";   // This text will be displayed, a letter a time
